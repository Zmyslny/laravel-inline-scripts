...
<button
    x-data="{
        refresh() {
            this.isSystem = localStorage.getItem('colorScheme') === 'system';
            this.isDark = localStorage.getItem('colorScheme') === 'dark';
            this.isLight = localStorage.getItem('colorScheme') === 'light';
        }
    }"
        x-init="refresh()"
        {{--
