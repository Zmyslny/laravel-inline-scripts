...
class BladeInlineScriptsProvider extends ServiceProvider
{
    ...
    public function publishColorScheme2States(): void
    {
        $this->publishes([
            ...
            __DIR__.'/../scripts/ColorSchemeSwitchTwoStates/js/switch-script.js' => resource_path(
                'js/color-scheme-switch-two-states/switch-script.js'
            ),
        ], ['color-scheme-switch-2-states-js', 'color-scheme-switch-2-states-all']);

        $this->publishes([
            __DIR__.'/../tests/js/color-scheme-switch-two-states/init-script.test.js' => base_path(
                'tests/js/color-scheme-switch-two-states/init-script.test.js'
            ),
            __DIR__.'/../tests/js/color-scheme-switch-two-states/switch-script.test.js' => base_path(
    ...
    public function publishColorScheme3States(): void
    {
        $this->publishes([
            ...
            __DIR__.'/../scripts/ColorSchemeSwitchThreeStates/js/switch-script.js' => base_path(
                'js/color-scheme-switch-three-states/switch-script.js'
            ),
        ], ['color-scheme-switch-3-states-js', 'color-scheme-switch-3-states-all']);

        $this->publishes([
            __DIR__.'/../tests/js/color-scheme-switch-three-states/init-script.test.js' => base_path(
                'tests/js/color-scheme-switch-three-states/init-script.test.js'
            ),
            __DIR__.'/../tests/js/color-scheme-switch-three-states/switch-script.test.js' => base_path(
