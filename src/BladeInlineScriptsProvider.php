...
class BladeInlineScriptsProvider extends ServiceProvider
{
    ...
    public function publishColorScheme2States(): void
    {
        ...
        ], ['color-scheme-2-states-js', 'color-scheme-2-states-all']);
        ...
        ], ['color-scheme-2-states-js-tests', 'color-scheme-2-states-all']);
        ...
        ], ['color-scheme-2-states-views', 'color-scheme-2-states-all']);
    ...
    public function publishColorScheme3States(): void
    {
        ...
        ], ['color-scheme-3-states-js-tests', 'color-scheme-3-states-all']);
